...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $product = [
            ...
            [
                'name' => 'Culotes',
                'description' => 'is a piece of clothing that looks like a combination of skirt used by womens',
                'price' => '150000',
            ...
            [
                'name' => 'Cargo',
                'description' => 'is one type of pants that has many protruding pockets used men',
                'price' => '60000',
